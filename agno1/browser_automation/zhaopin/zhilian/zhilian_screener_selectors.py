# agno1/browser_automation/zhaopin/zhilian/zhilian_screener_selectors.py
...
ZHILIAN_SCREENER_SELECTORS = PlatformSelectors(
...
# 向后兼容别名
ZHILIAN_RESUME_SELECTORS = ZHILIAN_SCREENER_SELECTORS

__all__ = ["ZHILIAN_SCREENER_SELECTORS", "ZHILIAN_RESUME_SELECTORS"]
